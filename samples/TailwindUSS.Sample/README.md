...
- `AGENTS.md`: example agent instructions for Copilot / Codex / Claude Code when editing this sample
- `SKILL.md`: sample-local TailwindUSS skill with supported utility guidance for coding agents
...
- `AGENTS.md`: Copilot / Codex / Claude Code がこのサンプルを編集するときの instruction 例
- `SKILL.md`: 対応 utility の範囲や注意点をエージェントへ伝えるサンプル用スキル
