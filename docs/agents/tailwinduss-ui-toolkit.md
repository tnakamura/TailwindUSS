...
- When the project includes the TailwindUSS skill file at `.github/skills/tailwinduss-ui-toolkit/SKILL.md` or merged into another skill file, read it before proposing new utility classes so you stay within the supported TailwindUSS subset.
